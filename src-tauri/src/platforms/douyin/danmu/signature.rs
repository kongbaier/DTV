...
pub async fn generate_signature(
    ...
    debug!(
        "[Douyin Danmaku] String to MD5 for signature: {}",
        to_sign_str
    );
    ...
    runtime
        ...
        .map_err(|e| {
            error!(
                "[Douyin Danmaku] Error during deno_core bootstrap script: {}",
                e
            );
            e
        })?;
    ...
    runtime
        ...
        .map_err(|e| {
            error!(
                "[Douyin Danmaku] Error during deno_core eval of sign.js: {}",
                e
            );
            e
        })?;
    ...
    let result = runtime
        ...
        .map_err(|e| {
            error!(
                "[Douyin Danmaku] Error during deno_core call to get_sign: {}",
                e
            );
            e
        })?;
